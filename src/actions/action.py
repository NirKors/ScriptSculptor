...
class Action:
    ...
    def explanatory_tooltip(self, text):
        ...
        tooltip_frame = ttk.Frame(self.parent_frame, style="buttons_frame.TFrame", width=20, height=20, borderwidth=0)
        ...
        tooltip_label = ttk.Label(tooltip_frame, text="?", font=("Arial", 15), style="QuestionMark.TLabel")
